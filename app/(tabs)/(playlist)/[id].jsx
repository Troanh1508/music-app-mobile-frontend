...
const PlaylistScreen = () => {
	...
	const { fetchSongsInPlaylist, songsInPlaylist, fetchPlaylistById, playlist } = useMusicStore();
	...
	const filteredSongs = songsInPlaylist.filter(song =>
